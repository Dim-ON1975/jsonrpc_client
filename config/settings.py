...
SECRET_KEY = "django-insecure-2=(n6t1oakin*m0jjd0i31l1c7an6%x8&@bu#u7*i)%=edkz68"
...
# Эндпоинт
ENDPOINT = 'https://slb.medv.ru/api/v2/'

# Задаем содержимое сертификата и ключа в виде текстовых переменных
CERTIFICATE_CONTENT = """
Certificate:
    Data:
        Version: 1 (0x0)
